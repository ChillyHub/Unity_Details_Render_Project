Shader "Custom/Avatar/AvatarFace_StencilMask"
{
    Properties
    {
	    [Foldout(Textures)]
    	...
    	[Space]
    	_FrontDirection("Face Front Direction", Vector) = (0.0, 0.0, -1.0, 0.0)
    	_RightDirection("Face Right Direction", Vector) = (-1.0, 0.0, 0.0, 0.0)
    	[FoldEnd]
        ...
        [Foldout(Blush, _BLUSH_ON)]
    	_Emission_Intensity("Blush Intensity", Range(0, 8)) = 1
	    _Emission_Color("Blush Color", Color) = (1.0, 0.2, 0.6)
	    [FoldEnd]
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Tags { "LightMode" = "AvatarObject" "QUEUE" = "Geometry+10" }
            ...
            #pragma shader_feature _BLUSH_ON
            #pragma shader_feature _GI_ON
            #pragma shader_feature _RIM_ON
            #pragma shader_feature _EDGE_RIM_ON
            #pragma shader_feature _RECEIVE_LIGHT_SHADOWS
            #pragma shader_feature _RECEIVE_DEPTH_SHADOWS
            ...
            #include "Assets/Shaders/Avatar/AvatarFaceRenderPass.hlsl"
