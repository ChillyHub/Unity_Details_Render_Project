Shader "Custom/Avatar/AvatarHair_StencilOut"
{
    Properties
    {
	    [Foldout(Textures)]
    	...
    	[Toggle(_VARYING_ALPHA)] _VaryingAlphaToggle("Alpha Varying", Float) = 1
    	[FoldEnd]
    ...
    SubShader
    {
        ...
        Pass
        {
            ...
            Tags { "LightMode" = "AvatarObject" "QUEUE" = "Geometry+20" }
            ...
            #include "Assets/Shaders/Avatar/AvatarHairRenderPass.hlsl"
        ...
        {
            Name "Avatar Render Pass"
            Tags { "LightMode" = "AvatarObject2" "Queue" = "Geometry+20" }
            ...
            #pragma shader_feature _VARYING_ALPHA
