    ...
    public partial class VirtualMesh
    {
        ...
        public void Reduction(ReductionSettings settings, CancellationToken ct)
        {
            ...
            try
            {
                ...
                //Debug.Log($"ReductionDista. maxExtent:{maxBoundingExtent}, same:{sameDistance}, simple:{simpleDistance}, shape:{shapeDistance}");
        ...
        void InitReductionWorkData(ReductionWorkData workData)
        {
            try
            {
                ...
                workData.vertexToVertexMap = new NativeMultiHashMap<ushort, ushort>(vertexCount, Allocator.Persistent);
#else
...
#if MC2_COLLECTIONS_200
            public NativeMultiHashMap<ushort, ushort> vertexToVertexMap;
#else
        ...
        void OrganizationInit(ReductionSettings setting, ReductionWorkData workData)
        {
            ...
            //OrganizationCreateBasicData用
            {
                ...
                // 新しい頂点の接続頂点リスト
#if MC2_COLLECTIONS_200
                workData.newVertexToVertexMap = new NativeMultiHashMap<ushort, ushort>(newVertexCount, Allocator.Persistent);
#else
...
#if MC2_COLLECTIONS_200
            [Unity.Collections.ReadOnly]
            public NativeMultiHashMap<ushort, ushort> oldVertexToVertexMap;
            [NativeDisableParallelForRestriction]
            public NativeMultiHashMap<ushort, ushort> newVertexToVertexMap;
#else
            [Unity.Collections.ReadOnly]
