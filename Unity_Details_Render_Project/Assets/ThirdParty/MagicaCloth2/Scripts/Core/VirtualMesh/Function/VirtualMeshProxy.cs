...
namespace MagicaCloth2
{
    public partial class VirtualMesh
    {
            ...
            )
        {
            try
            {
                ...
                if (TriangleCount > 0)
                {
                    ...
                    edgeToTriangles = new NativeMultiHashMap<int2, ushort>(TriangleCount * 2, Allocator.Persistent);
#else
...
#if MC2_COLLECTIONS_200
                    edgeToTriangles = new NativeMultiHashMap<int2, ushort>(1, Allocator.Persistent);
#else
        ...
        struct Proxy_CalcEdgeToTriangleJob : IJob
        {
            ...
            public NativeArray<int3> triangles;
#if MC2_COLLECTIONS_200
            public NativeMultiHashMap<int2, ushort> edgeToTriangles;
#else
        ...
        struct Proxy_CalcVertexToVertexFromTriangleJob : IJob
        {
            ...
            public NativeArray<int3> triangles;
#if MC2_COLLECTIONS_200
            public NativeMultiHashMap<int, ushort> vertexToVertexMap;
#else
...
#if MC2_COLLECTIONS_200
            [Unity.Collections.ReadOnly]
            public NativeMultiHashMap<int3, int> gridMap;
#else
            [Unity.Collections.ReadOnly]
        ...
        struct BaseLine_Mesh_CreateParentJob2 : IJob
        {
            ...
            public NativeArray<int> vertexParentIndices;
#if MC2_COLLECTIONS_200
            public NativeMultiHashMap<int, ushort> vertexChildMap;
#else
...
#if MC2_COLLECTIONS_200
            [Unity.Collections.WriteOnly]
            public NativeMultiHashMap<int, ushort> childMap;
#else
            [Unity.Collections.WriteOnly]
