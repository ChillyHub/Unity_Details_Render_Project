...
namespace MagicaCloth2
{
    ...
    static class NativeMultiHashMapExtensions
    {
        ...
        public static bool Contains<TKey, TValue>(ref this NativeMultiHashMap<TKey, TValue> map, TKey key, TValue value) where TKey : unmanaged, IEquatable<TKey> where TValue : unmanaged, IEquatable<TValue>
#else
        ...
        /// <param name="value"></param>
#if MC2_COLLECTIONS_200
        public static void UniqueAdd<TKey, TValue>(ref this NativeMultiHashMap<TKey, TValue> map, TKey key, TValue value) where TKey : unmanaged, IEquatable<TKey> where TValue : unmanaged, IEquatable<TValue>
#else
        ...
        /// <returns></returns>
#if MC2_COLLECTIONS_200
        public static FixedList512Bytes<TValue> ToFixedList512Bytes<TKey, TValue>(ref this NativeMultiHashMap<TKey, TValue> map, TKey key) where TKey : unmanaged, IEquatable<TKey> where TValue : unmanaged, IEquatable<TValue>
#else
        ...
        /// <returns></returns>
#if MC2_COLLECTIONS_200
        public static FixedList128Bytes<TValue> ToFixedList128Bytes<TKey, TValue>(ref this NativeMultiHashMap<TKey, TValue> map, TKey key) where TKey : unmanaged, IEquatable<TKey> where TValue : unmanaged, IEquatable<TValue>
#else
