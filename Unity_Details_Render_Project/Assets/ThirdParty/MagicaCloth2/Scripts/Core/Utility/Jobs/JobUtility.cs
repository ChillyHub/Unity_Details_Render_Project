...
namespace MagicaCloth2
{
    public static class JobUtility
    {
        ...
        public static JobHandle ConvertMultiHashMapKeyToNativeList(
            ...
            NativeMultiHashMap<int2, int> hashMap,
#else
...
#if MC2_COLLECTIONS_200
            [Unity.Collections.ReadOnly]
            public NativeMultiHashMap<T, U> hashMap;
#else
            [Unity.Collections.ReadOnly]
        ...
        /// <returns></returns>
#if MC2_COLLECTIONS_200
        public static NativeMultiHashMap<int, ushort> ToNativeMultiHashMap(in NativeArray<uint> indexArray, in NativeArray<ushort> dataArray)
#else
        ...
        {
#if MC2_COLLECTIONS_200
            var map = new NativeMultiHashMap<int, ushort>(dataArray.Length, Allocator.Persistent);
#else
...
#if MC2_COLLECTIONS_200
            [Unity.Collections.WriteOnly]
            public NativeMultiHashMap<int, TData> map;
#else
            [Unity.Collections.WriteOnly]
